// JUBATUS_CORE_REGRESSION_AROW_HPP_
...
#ifndef JUBATUS_CORE_REGRESSION_AROW_HPP_
#define JUBATUS_CORE_REGRESSION_AROW_HPP_
...
class arow : public linear_regression {
 public:
  struct config {
    config()
...
#endif  // JUBATUS_CORE_REGRESSION_AROW_HPP_

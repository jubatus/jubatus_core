...
#ifndef JUBATUS_CORE_CLASSIFIER_RECOMMENDER_CLASSIFIER_HPP_
#define JUBATUS_CORE_CLASSIFIER_RECOMMENDER_CLASSIFIER_HPP
...
class recommender_classifier : public classifier_base {
 public:
  recommender_classifier(
      jubatus::util::lang::shared_ptr<recommender::recommender_base>
          recommender_engine,
      size_t k, 
      float alpha);
...
#endif  // JUBATUS_CORE_CLASSIFIER_RECOMMENDER_CLASSIFIER_HPP
